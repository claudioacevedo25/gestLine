...
<body>
    <div id="app">
        ...
        <footer id="footer" class="footer-1">
            ...
            <h5 class="widget-title">GESTLINE<span></span></h5>
            <p>Llevamos tu negocio a su maximo rendimiento, con tareas sencillas... </p>
            </div>
            </div>
            ...
            <p><a href="mailto:info@domain.com" title="glorythemes">claudioacevedo25@gmail.com</a></p>
                 ...
                 <div class="container">
                     <div class="row">
                         <div class="col-md-12 text-center">
                             <p>Copyright GestLine © 2020. Todos los derechos reservados.</p>
                         </div>
                     </div>
                 </div>
            </div>
